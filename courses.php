...
class Courses extends CI_Controller {
        ...
        public function registration($type = 0,$event_id=0)
	{
		...
		//	echo "<br>Price : ".$event_detail[0]->price;
            ...
            {
                $return_url = "http://www.topofthelinesecurity.com/_index.php?courses/sucess"; 
                $cancel_url = "http://www.topofthelinesecurity.com/_index.php?courses/registration/".$data['type']."/".$data['event_id']; 
