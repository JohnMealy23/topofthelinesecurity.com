...
//                    {
	...
	public function event_list($id = 0)
	{
            ...
            foreach($data['users'] as $event_index)
            {
                ...
                $csv_array = array(); 
                $csv_array[$counter][0] = "First Name";
                $csv_array[$counter][1] = "Middle Name";
                $csv_array[$counter][2] = "Last Name";
                $csv_array[$counter][3] = "Name on Certificate";
                $csv_array[$counter][4] = "Suffix";
                $csv_array[$counter][5] = "Street Address";
                $csv_array[$counter][6] = "City";
                $csv_array[$counter][7] = "State";
                $csv_array[$counter][8] = "Zip";
                $csv_array[$counter][9] = "Phone";
                $csv_array[$counter][10] = "Email";
                $csv_array[$counter][11] = "Event Type";
                $this->csvDump($csv_array,$fh);
				$csv_array = array();
                $this_counter = 1;
                ...
                {
                    $this_counter++;
                    $csv_array[$this_counter][0] = $this_event->first_name;
                    $csv_array[$this_counter][1] = $this_event->middle_name;
                    $csv_array[$this_counter][2] = $this_event->last_name;
                    $csv_array[$this_counter][3] = $this_event->name_on_certificate;
                    $csv_array[$this_counter][4] = $this_event->suffix;
                    $csv_array[$this_counter][5] = $this_event->street_address;
                    $csv_array[$this_counter][6] = $this_event->city;
                    $csv_array[$this_counter][7] = $this_event->state;
                    $csv_array[$this_counter][8] = $this_event->zip;
                    $csv_array[$this_counter][9] = $this_event->phone;
                    $csv_array[$this_counter][10] = $this_event->email;
                    $csv_array[$this_counter][11] = $this_event->event_type;
